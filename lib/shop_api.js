...
(function() {
  ...
  ShopAPI = (function(superClass) {
    ...
    ShopAPI.prototype.saveMember = function(options, cb) {
      var name, required;
    ...
    ShopAPI.prototype.updateMember = function(options, cb) {
      var name, required;
    ...
    ShopAPI.prototype.deleteMember = function(options, cb) {
      var name, required;
    ...
    ShopAPI.prototype.searchMember = function(options, cb) {
      var name, required;
